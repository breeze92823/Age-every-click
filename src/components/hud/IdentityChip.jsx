...
// identity the client resolved, just the interactive AuthPanel. Ported
// verbatim from Ice-Skate's components/hud/IdentityChip.jsx.
const DEV_ONLY = import.meta.env.DEV

// Top-left identity chip: "Guest" + Bloxity's default picture until login,
// the real avatar + name after. Unlike AuthPanel (top-right), this always
// renders while active, and it has no interactive controls, so it stays
// pointer-events-none. Event-driven via useAuth(); never re-renders per frame.
